...
export default class GridSection extends React.Component {
    render() {
        ...
        return (
            <section className={classNames('Gridsection',_.get(section, 'class_name', null))} style={toStyleObj('background-image: url(\'' + withPrefix(_.get(section, 'bg_image', null)) + '\')')}>  
                <div className="container container--lg">
                    ...
                    <div className={classNames('grid', {'grid-col-4': _.get(section, 'grid_column', null) === 'four', 'grid-col-3': _.get(section, 'grid_column', null) === '3'})}>
                        ...
                        <div className="grid-item-inside card">
                            ...
                            <img src={withPrefix(_.get(item, 'icon', null))}  alt="Card Image"/>
                            </div>
                            )}
