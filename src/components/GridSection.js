...
export default class GridSection extends React.Component {
    render() {
        console.log(this.props.section.grid_column);
        ...
        return (
            <section className={classNames('gfg')}>  
                ...
                <div className="block-content">
                  <div className={classNames('grid', {'grid-col-2': _.get(section, 'grid_column', null) === 'two', 'grid-col-3': _.get(section, 'grid_column', null) === 'three'})}>
